...
#
# Flutter :
export PATH="$PATH:/Users/junjie/Flutter/bin"
# Dart :
export PATH="$PATH:/Users/junjie/flutter/bin/cache/dart-sdk/bin"
...
__conda_setup="$('/Users/junjie/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/junjie/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/junjie/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/junjie/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
